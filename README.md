...
![Streamlit Dashboard](images/streamlit_dashboard_premium.png)
...
![Model 3 Schedule](images/Model_3_schedule_table.png)
> *최종 스케줄은 직원들의 개인 휴무 요청, 공휴일, 그리고 필수 교대 근무 커버리지를 완벽하게 균형 맞추어 배정합니다.*

### 2. 번아웃 및 피로도 방지 (연속 근무 일수 제어)
![Model 3 Consecutive Days](images/Model_3_consecutive_chart.png)
...
![Model 3 Penalties](images/Model_3_penalty_chart.png)
...
![Simulated Annealing](images/simulated_annealing_curve.png)
...
- **Model 1 (기본 튜닝):** 
  ![Model 1 Chart](images/Model_1_consecutive_chart.png)
  *공정성 제약 없이 Tabu Search 알고리즘만 사용한 결과입니다. 특정 직원에게 업무가 몰려 최대 6일까지 휴일 없이 연속으로 과로하는 현상이 발생했습니다.*
  
- **Model 2 (제곱 페널티 공정성):** 
  ![Model 2 Chart](images/Model_2_consecutive_chart.png)
